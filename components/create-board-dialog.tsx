      ...
      {open && createPortal(
        ...
        <form action={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="title" className="text-amber-800 font-semibold">クエストボード名 *</Label>
            <Input
              id="title"
              name="title"
          ...
          <div className="space-y-2">
            <Label htmlFor="description" className="text-amber-800 font-semibold">クエストの説明</Label>
            <Textarea
              id="description"
              name="description"
